    ...
    <div>
         ...
         <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">info sur les cérémonies</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start --> 
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <div class="col-sm-12">
                    <label for="">Objet de la cérémonie</label>
                    <textarea type="time" v-model="formImg.objet_ceremonie" class="form-control" rows="2" placeholder=""></textarea>
                   </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="" class="btn btn-primary" @click.prevent="ajouterCeremonieLocal">Valider</button>
...
...mapGetters("Utilisateurs",["gettersListeCeremonie"]),
    ...
    methods:{
   ...mapActions("Utilisateurs",["ajouterCeremonie"]),
   ...
   allerPage(){
      ...
      ajouterCeremonieLocal(){
                ...
                formData.append('objet_ceremonie', this.formImg.objet_ceremonie);
                ...
                this.ajouterCeremonie(formData,config)
                  this.$router.push({
                name:"ceremonie"
                  });
                this.formImg= {
